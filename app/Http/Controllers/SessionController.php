...
class SessionController extends Controller
{
    ...
    function login(Request $request)
    {
        ...
        if (Auth::attempt($infologin)) {
            return redirect('/admin/menejemen/datalaporan')->with('success','Anda Berhasil Login');
        } else{
    ...
    function create(Request $request){
        ...
        if (Auth::attempt($infologin)) {
            return redirect('/admin/menejemen/datalaporan')->with('success', Auth::user()->name. 'Anda Berhasil Login');
        } else{
            return redirect('sesi')->withErrors('Username dan Password yang dimasukan tidak valid');
        }
    }
